...
module azureOpenAIEmbeddingsEngineName 'core/keyvault/keyvault-secret.bicep' = {
  ...
  params: {
    ...
    secretValue: embeddingsGptDeploymentName ? embeddingsGptDeploymentName : 'text-embedding-ada-002'
  }
  dependsOn: [
    keyVault
    openAi
...
module azureOpenAIEmbeddingsDimensions 'core/keyvault/keyvault-secret.bicep' = {
  ...
  params: {
    ...
    secretValue: embeddingsDimensions ? embeddingsDimensions : '1536'
  }
  dependsOn: [
    keyVault
  ]
...
module azureOpenAIEmbeddingsTokenLimit 'core/keyvault/keyvault-secret.bicep' = {
  ...
  params: {
    ...
    secretValue: embeddingsTokenLimit ? embeddingsTokenLimit : '8191'
  }
  dependsOn: [
    keyVault
  ]
